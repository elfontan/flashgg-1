...
#alp
eventsalp = Events(alpPlusjetFiles30)
...
genleadetaalp.SaveAs("Plots/LeadEta/gen_alpPlusjet30.root")
gensubleadetaalp.SaveAs("Plots/SubleadEta/gen_alpPlusjet30.root")
genleadptalp.SaveAs("Plots/LeadPT/gen_alpPlusjet30.root")
gensubleadptalp.SaveAs("Plots/SubleadPT/gen_alpPlusjet30.root")
gendiphotonptalp.SaveAs("Plots/DiphotonPT/gen_alpPlusjet30.root")
gendralp.SaveAs("Plots/DR/gen_alpPlusjet30.root")

genleadetaalpacc.SaveAs("Plots/LeadEta/gen_alpPlusjet30acc.root")
gensubleadetaalpacc.SaveAs("Plots/SubleadEta/gen_alpPlusjet30acc.root")
genleadptalpacc.SaveAs("Plots/LeadPT/gen_alpPlusjet30acc.root")
gensubleadptalpacc.SaveAs("Plots/SubleadPT/gen_alpPlusjet30acc.root")
gendiphotonptalpacc.SaveAs("Plots/DiphotonPT/gen_alpPlusjet30acc.root")
gendralpacc.SaveAs("Plots/DR/gen_alpPlusjet30acc.root")
